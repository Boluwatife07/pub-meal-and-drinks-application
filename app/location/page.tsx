    ...
    <div>
        <div className=' bg-white h-screen'>
            ...
            <div className=' bg-red-700 py-10 text-center justify-center px-4 rounded-lg flex flex-col gap-3'>
                <div className='   rounded-[50%] border-4 justify-center flex p-1' >
                <ImSpoonKnife size={80} className=' bg-white text-red-500 rounded-[50%] px-4 border' />
                </div>
                <div className=' text-lg font-bold'>Dine-in</div>
                </div>
                <div className='  py-10 text-center justify-center px-4 rounded-lg border flex flex-col gap-3'>
