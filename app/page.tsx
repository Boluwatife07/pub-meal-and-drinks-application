      ...
      <div className="bg-white h-screen">
        <div className="flex h-full justify-center items-center">
          <div className="grid grid-cols-2 gap-10">
            <a
              href="/menu" 
              className="bg-red-700 py-10 text-center justify-center px-4 rounded-lg flex flex-col gap-3"
            >
            ...
            <a
              href="/menu" // Link to the take-away page
              className="py-10 text-center justify-center px-4 rounded-lg border border-gray-400 flex flex-col gap-3"
            >
